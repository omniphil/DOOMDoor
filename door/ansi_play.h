/*
 * ansi_play.h -- playing Doom in ANSI, for callers without TRACE. See ansi_play.c.
 */
...
typedef enum
{
    PLAY_QUIT,          /* the player quit Doom */
...
/* Runs Doom here and shows it on the caller's 80x24 screen until they quit. */
