/*
 * ansi_input.h -- a terminal's keystrokes turned into Doom's key presses and releases. See ansi_input.c.
 */
 ...
 * repeating it. `menu` says Doom's menu is up (keys are tapped as themselves), `typing` that a savegame name is being
 * typed (letters must stay letters).
 */
